...
<template>
  <div
    ...
    :class="{
      'bg-blue-50 border-blue-300 shadow-sm': !isSelected,
      'bg-blue-50 border-blue-500 ring-2 ring-blue-500/50 shadow-md': isSelected,
    }"
    style="width: 280px"
  ...
  >
    ...
    <div class="flex items-center gap-2 mb-2">
      <span class="w-6 h-6 flex items-center justify-center rounded bg-blue-500 text-white text-[10px] font-bold">用户</span>
      <span class="text-xs font-semibold text-blue-600 tracking-wider">用户消息</span>
