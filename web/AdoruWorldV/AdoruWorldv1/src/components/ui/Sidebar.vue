  ...
  <aside class="space-y-6">
    <div class="pixel-card p-5">
      <div class="flex items-center gap-4 mb-4">
        ...
        <div>
          <h3 class="pixel-text text-sm text-pokemon-black">{{ store.authorInfo.name }}</h3>
    ...
    <div class="pixel-card p-5">
      <h3 class="pixel-text text-xs text-pokemon-black mb-4 flex items-center gap-2">
    ...
    <div class="pixel-card p-5">
      ...
      <div class="space-y-3">
        ...
        >
          ...
          <p class="text-xs text-pokemon-dark-gray mt-1">{{ post.created_at }}</p>
        </router-link>
      </div>
    </div>
  </aside>
