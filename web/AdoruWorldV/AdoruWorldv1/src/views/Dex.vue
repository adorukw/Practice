...
import { dexEntries, dexCategories, dexStatuses, dexStats, getCategoryInfo, getStatusInfo } from '@/data/dex'
            ...
            <div class="pixel-card overflow-hidden">
              <div class="relative aspect-[3/4] overflow-hidden">
                ...
                <div class="absolute bottom-0 left-0 right-0 p-3">
                  <div class="pixel-text text-xs text-white mb-1 line-clamp-2">
            ...
            <div class="pixel-card p-4 flex gap-4 items-center">
              ...
              <div class="flex-1 min-w-0">
                <div class="flex items-center gap-2 mb-1">
                  <span class="pixel-text text-xs text-pokemon-dark-gray">
                    #{{ String(index + 1).padStart(3, '0') }}
                  </span>
                  <h3 class="pixel-text text-sm text-pokemon-black truncate">{{ entry.title }}</h3>
                </div>
