      ...
      <div class="flex items-center justify-between h-16">
        ...
        <nav class="hidden md:flex items-center gap-1">
          <router-link
            ...
            :key="item.path"
            :to="item.path"
            class="px-4 py-2 text-pokemon-black pixel-text text-sm transition-all duration-100
      ...
      >
        <nav class="flex flex-col gap-2">
          <router-link
            ...
            :key="item.path"
            :to="item.path"
            class="px-4 py-3 text-pokemon-black pixel-text text-sm transition-all duration-100
