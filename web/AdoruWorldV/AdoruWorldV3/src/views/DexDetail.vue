      ...
      <section class="relative py-8 overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 relative z-10">
          <div class="flex items-center gap-2 mb-4">
            ...
            <span class="pixel-text text-base text-pokemon-dark-gray">返回图鉴</span>
          </div>
        </div>
      </section>
                ...
                <div class="relative aspect-[3/4]">
                  ...
                  <div class="absolute bottom-3 left-3 right-3">
                    <div class="bg-white/90 backdrop-blur-sm rounded border-3 border-pokemon-black p-2">
                      <div class="pixel-text text-base text-pokemon-dark-gray">
              ...
              <div class="pixel-card p-6 mb-6">
                ...
                <div v-if="entry.rating > 0" class="mb-6">
                  <div class="flex items-center gap-3 mb-2">
                    <span class="pixel-text text-base text-pokemon-black">评分</span>
                ...
                <div v-if="entry.total > 1" class="mb-6">
                  <div class="flex items-center justify-between mb-2">
                    <span class="pixel-text text-base text-pokemon-black">进度</span>
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                  <div v-if="entry.creator" class="p-3 bg-pokemon-gray/30 rounded border-2 border-pokemon-black">
                    <div class="pixel-text text-base text-pokemon-dark-gray mb-1">创作者</div>
                  ...
                  <div v-if="entry.year" class="p-3 bg-pokemon-gray/30 rounded border-2 border-pokemon-black">
                    <div class="pixel-text text-base text-pokemon-dark-gray mb-1">年份</div>
                  ...
                  <div v-if="entry.platform" class="p-3 bg-pokemon-gray/30 rounded border-2 border-pokemon-black">
                    <div class="pixel-text text-base text-pokemon-dark-gray mb-1">平台</div>
                  ...
                  <div v-if="entry.startDate" class="p-3 bg-pokemon-gray/30 rounded border-2 border-pokemon-black">
                    <div class="pixel-text text-base text-pokemon-dark-gray mb-1">开始日期</div>
                    <div class="text-sm text-pokemon-black">{{ entry.startDate }}</div>
                  </div>
                </div>

                <div v-if="entry.tags.length" class="mb-6">
                  <div class="pixel-text text-base text-pokemon-black mb-3">标签</div>
                ...
                <div v-if="entry.genre?.length" class="mb-6">
                  <div class="pixel-text text-base text-pokemon-black mb-3">类型</div>
                  <div class="flex flex-wrap gap-2">
                    <span
              ...
              <div v-if="relatedEntries.length" class="pixel-card p-6">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  ...
                  >
                    ...
                    <div class="pixel-text text-base text-pokemon-black line-clamp-1 group-hover:text-sky-dark">
                      {{ related.title }}
                    </div>
                  </router-link>
                </div>
    ...
    <template v-else>
      <div class="min-h-[60vh] flex items-center justify-center">
        <div class="text-center">
          ...
          <router-link to="/dex" class="pixel-btn bg-sky-dark text-white hover:bg-pokemon-blue">
            返回图鉴
          </router-link>
        </div>
      </div>
