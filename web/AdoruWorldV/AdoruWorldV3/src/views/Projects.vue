            ...
            >
              ...
              <div class="p-6">
                <div class="flex items-center justify-between mb-3">
                  <h3 class="pixel-text text-base text-pokemon-black">{{ project.name }}</h3>
                ...
                <div class="flex gap-3">
                  <a
                    ...
                    :href="project.link"
                    target="_blank"
                    class="pixel-btn bg-sky-dark text-white text-sm py-2 px-4 hover:bg-pokemon-blue"
                  >
                    访问
                  </a>
                  <a
                    ...
                    :href="project.github"
                    target="_blank"
                    class="pixel-btn bg-pokemon-dark-gray text-white text-sm py-2 px-4"
                  >
                    GitHub
                  </a>
                </div>
        ...
        <div v-if="groupedProjects['completed'].length" class="mb-12">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              />
              <div class="p-5">
                <h3 class="pixel-text text-base text-pokemon-black mb-2">{{ project.name }}</h3>
