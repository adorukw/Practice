        ...
        <div class="max-w-4xl mx-auto px-4 py-12">
          ...
          <div class="mt-12 pt-8 border-t-4 border-pokemon-black">
            <div class="dialog-box mb-8">
              <p class="pixel-text text-base text-pokemon-black">
            ...
            <div class="flex flex-wrap gap-4 justify-center">
              <button
                @click="scrollToTop"
                class="pixel-btn bg-sky-dark text-white hover:bg-pokemon-blue"
              >
                返回顶部
              </button>
              <router-link
    ...
    <template v-else>
      <div class="min-h-[60vh] flex items-center justify-center">
        <div class="text-center">
          ...
          <router-link to="/" class="pixel-btn bg-sky-dark text-white hover:bg-pokemon-blue">
            返回首页
          </router-link>
        </div>
      </div>
